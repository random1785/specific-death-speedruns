# multi 5
execute as @e[tag=score] run scoreboard players set @a[scores={done=0},tag=!a] calc 3000
execute as @e[tag=score] run scoreboard players set @a[scores={done=1},tag=!a] calc 2400
execute as @e[tag=score] run scoreboard players set @a[scores={done=2},tag=!a] calc 2050
