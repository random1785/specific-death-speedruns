...
execute unless entity @e[type=armor_stand,tag=score,scores={al=69,am=69,bp=69,bq=69,br=69,bs=69,bt=69,bu=69,bv=69,bx=69}] run tellraw @a[scores={reminder=1..}] {"color":"dark_red","text":"Note: You cannot get fall damage deaths (other than fell from a high place/doomed to fall) if you have taken fall damage within the last 5 seconds!"}
