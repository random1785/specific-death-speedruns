...
execute as @e[type=armor_stand,tag=score,scores={al=17}] run tellraw @a[scores={reminder=1..}] {"color":"dark_red","text":"You cannot get hit the ground too hard if you have taken fall damage within the last 5 seconds!"}
...
execute as @e[type=armor_stand,tag=score,scores={am=17}] run tellraw @a[scores={reminder=1..}] {"color":"dark_red","text":"You cannot get hit the ground too hard if you have taken fall damage within the last 5 seconds!"}
