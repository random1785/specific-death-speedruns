...
execute as @e[tag=score] run scoreboard players set @a[scores={done=0},tag=!a] calc 5000
execute as @e[tag=score] run scoreboard players set @a[scores={done=1},tag=!a] calc 4500
execute as @e[tag=score] run scoreboard players set @a[scores={done=2},tag=!a] calc 4100
